 ...
 * @author jsjef
 */
public class GuardaMultiplicacao {

    public static void main(String[] args) {

//        8. Criar dois vetores A e B cada um com 10 elementos inteiros. Construir um vetor C, onde cada elemento de C é a multiplicação
